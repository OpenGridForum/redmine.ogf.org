...
- To validate the xml docs, the XSDs need to be in the same folder (unless you 
 ...
 to validate as follows (available for linux and via cygwin for win):   
  ...
  $xmllint --noout --schema glue2_2.xsd glue2_2SampleDoc1.xml 
  glue2_2SampleDoc1.xml validates
 
  $xmllint --noout --schema glue2_2.xsd glue2_2SampleManyEndpoints.xml
  glue2_2SampleManyEndpoints.xml validates

  $xmllint --noout --schema sampleGlue2_2Extension.xsd sampleGlue2_2ExtensionDoc.xml
  sampleGlue2_2ExtensionDoc.xml validates
